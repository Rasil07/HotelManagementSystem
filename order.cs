...
namespace Hotel_Management_System
{
    public partial class order : Form
    {
        ...
        private void cust_id_txt_TextChanged_1(object sender, EventArgs e)
        {
            ...
            string myconn = "datasource=localhost;port=3306;username=root;password=";
            string query = "SELECT * FROM hotelmanagement.customer where cust_id = '" + this.cust_id_txt.Text + "';";
            MySqlConnection Con = new MySqlConnection(myconn);
        ...
        private void addtocart_button_Click(object sender, EventArgs e)
        {
            check = true;
            string myconn = "datasource=localhost;port=3306;username=root;password=";
            string query = "INSERT INTO hotelmanagement.cart values('" + this.item_name_txt.Text + "'," + this.salequantity_txt.Text + "," + this.totalamount_txt.Text + ",'"+this.comboBox2.Text+"');";
            MySqlDataAdapter myDataAdapter = new MySqlDataAdapter();
            MySqlConnection Con = new MySqlConnection(myconn);
            MySqlCommand command = new MySqlCommand(query, Con);
        ...
        private void item_name_txt_MouseClick_1(object sender, MouseEventArgs e)
        {
            this.info_txt.Text = "";
        }

        private void item_name_txt_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            this.unit_price_txt.Text = "";
            this.available_quantity_txt.Text = "";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
           ...
           // MySqlCommand command2;
            ...
            MessageBox.Show(parse_quant(cust_id_txt.Text).ToString());
            MessageBox.Show(parse_price(GrandTotal_txt.Text).ToString());
            ...
            query2 = "UPDATE hotelmanagement.customer SET total_bill = total_bill + " +parse_price(this.GrandTotal_txt.Text)+" where cust_id = "+parse_quant(this.cust_id_txt.Text)+";";
            //query3 = "UPDATE hotelmanagement."+comboBox2.Text+" SET stock = stock -  (SELECT quantity from hotelmanagement.cart where item_name='' )  where item_name = '" + this.item_name_txt.Text + "';";
